...
| Screen | What happens |
|---|---|
| **Speak in 78 languages** | Pick a language, the voice downloads once, the phone says a greeting out loud. Synthesis is entirely local. |
...
```bash
dotnet build samples/CircleAI.Samples.Android/CircleAI.Samples.Android.csproj \
...
The shared, platform-neutral logic lives in `../CircleAI.Samples.Console/` and is the
