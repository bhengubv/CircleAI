...
public class MainActivity : Activity
{
    ...
    protected override async void OnCreate(Bundle? savedInstanceState)
    {
        ...
        Append($"Tap Languages to hear it speak in any of {SampleLanguages.All.Count} languages.\n");
    ...
    void BuildUi()
    {
        ...
        var languages = Ui.Action(this, $"Speak in {SampleLanguages.All.Count} languages", primary: true);
