...
// CircleAISessionHost.cs
//
// One brain per phone, not one per screen.
//
// EVERY SCREEN WAS BUILDING ITS OWN. HomeActivity created an CircleAISession for voice
...
public static class CircleAISessionHost
{
    const string Tag = "CircleAI.It";

    static readonly object Gate = new();
    static Task<CircleAI.Assistant.CircleAISession>? _loading;
    static CircleAI.Assistant.CircleAISession? _session;
    ...
    /// </remarks>
    public static Task<CircleAI.Assistant.CircleAISession> GetAsync(Context context)
    {
    ...
    static async Task<CircleAI.Assistant.CircleAISession> Load(string? nativeLibDir)
    {
        ...
        try
        {
            ...
            {
                var made = new CircleAI.Assistant.CircleAISession(
    ...
    {
        CircleAI.Assistant.CircleAISession? s;
