...
//
// Lives in Circle.AI.Companion (rather than Circle.AI.Memory) because it bridges
// two modules: Circle.AI.Tools (FacialMetricMatrix) and Circle.AI.Memory (AffectState).
