...
namespace CircleAI.Core
{
    ...
    /// <remarks>
    /// <para>
    /// CircleAI.Core deliberately knows nothing about CircleAI.Inference,
    /// CircleAI.Embeddings, CircleAI.Search, or CircleAI.Tools. Those
    ...
    /// (<c>CircleAI.Inference.IChatGenerator</c>) and tool invocation
    /// (<c>CircleAI.Tools.IToolBridge</c>) are not referenced from Core;
    ...
    public sealed class CircleEngine
    {
        ...
        /// <c>CircleAI.Embeddings.CircleEngineExtensions.WithEmbeddingService</c>.
