...
// GLOBAL-QUALIFIED ALIAS, because this file lives in CircleAI.Samples.App and
// the capture class lives in CircleAI.Assistant.Device. From inside the former,
// "CircleAI.Assistant.Device" binds against the enclosing namespace first and
