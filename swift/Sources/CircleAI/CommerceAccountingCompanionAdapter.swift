// CommerceAccountingCompanionAdapter.swift
//
// Port of CircleAI.Commerce.Accounting.CommerceAccountingCompanionAdapter.
//
...
/// An `ICompanionSession` decorator that prepends the commerceaccounting domain
/// system prompt to every conversational call.
public final class CommerceAccountingCompanionAdapter: ICompanionSession, @unchecked Sendable {
