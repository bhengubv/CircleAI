// CommerceCompanionAdapter.swift
//
// Port of CircleAI.Commerce.CommerceCompanionAdapter.
//
...
/// An `ICompanionSession` decorator that prepends the commerce domain
/// system prompt to every conversational call.
public final class CommerceCompanionAdapter: ICompanionSession, @unchecked Sendable {
    ...
    private func enrich(_ m: String) -> String {
        "\(CommerceDomainContext.systemPromptSnippet)\n\n\(m)"
    }
}
