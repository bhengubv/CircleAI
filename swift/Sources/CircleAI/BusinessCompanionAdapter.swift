// BusinessCompanionAdapter.swift
//
// Port of CircleAI.Business.BusinessCompanionAdapter.
//
...
/// An `ICompanionSession` decorator that prepends the business domain
/// system prompt to every conversational call.
public final class BusinessCompanionAdapter: ICompanionSession, @unchecked Sendable {
