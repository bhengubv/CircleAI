// CommerceFinanceCompanionAdapter.swift
//
// Port of CircleAI.Commerce.Finance.CommerceFinanceCompanionAdapter.
//
...
/// An `ICompanionSession` decorator that prepends the commercefinance domain
/// system prompt to every conversational call.
public final class CommerceFinanceCompanionAdapter: ICompanionSession, @unchecked Sendable {
