// CommerceIntegrationXeroCompanionAdapter.swift
//
// Port of CircleAI.Commerce.Integration.Xero.CommerceIntegrationXeroCompanionAdapter.
//
...
/// An `ICompanionSession` decorator that prepends the commerceintegrationxero domain
/// system prompt to every conversational call.
public final class CommerceIntegrationXeroCompanionAdapter: ICompanionSession, @unchecked Sendable {
