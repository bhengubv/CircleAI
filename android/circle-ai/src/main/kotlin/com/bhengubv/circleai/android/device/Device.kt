...
package com.bhengubv.circleai.android.device
...
data class DeviceProbe(
    ...
    companion object {
        ...
        private fun probeRamAvailable(): Long {
            // Android: no OperatingSystemMXBean. For OS-level free RAM the
            // host wires in ActivityManager.MemoryInfo from a Context.
            // Default to JVM heap as a conservative floor.
            return Runtime.getRuntime().let { r ->
