// Identity.kt
//
// Android/Kotlin port of Circle.AI.Identity portable layer.
//
// Covers:
...
package com.bhengubv.circleai.android.identity
...
data class BiometricProfile(
    ...
    override fun hashCode(): Int =
        identityId.hashCode() * 31 + embeddingVector.contentHashCode()
}
 ...
 * - Do NOT use SIMD, NDK, or FloatArray bulk operations here.
