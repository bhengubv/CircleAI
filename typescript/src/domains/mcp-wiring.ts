// Hosting.Mcp: what a host chose to make available.
//
 ...
 * happened to import.
 */
export class McpServiceCollectionExtensions {
  ...
  add(name: string, service: unknown): McpServiceCollectionExtensions {
