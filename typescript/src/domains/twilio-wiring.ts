// Telephony.Twilio: what a host chose to make available.
//
 ...
 * happened to import.
 */
export class TwilioServiceCollectionExtensions {
  ...
  add(name: string, service: unknown): TwilioServiceCollectionExtensions {
