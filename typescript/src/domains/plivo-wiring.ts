// Telephony.Plivo: what a host chose to make available.
//
 ...
 * happened to import.
 */
export class PlivoServiceCollectionExtensions {
  ...
  add(name: string, service: unknown): PlivoServiceCollectionExtensions {
