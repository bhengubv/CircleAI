// Hosting.Multiplayer: what a host chose to make available.
//
 ...
 * happened to import.
 */
export class MultiplayerServiceCollectionExtensions {
  ...
  add(name: string, service: unknown): MultiplayerServiceCollectionExtensions {
