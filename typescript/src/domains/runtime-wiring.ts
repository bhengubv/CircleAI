// Runtime: what a host chose to make available.
//
 ...
 * happened to import.
 */
export class CircleAIRuntimeServiceCollectionExtensions {
  ...
  add(name: string, service: unknown): CircleAIRuntimeServiceCollectionExtensions {
