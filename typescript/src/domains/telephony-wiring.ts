// Telephony: what a host chose to make available.
//
 ...
 * happened to import.
 */
export class TelephonyServiceCollectionExtensions {
  ...
  add(name: string, service: unknown): TelephonyServiceCollectionExtensions {
