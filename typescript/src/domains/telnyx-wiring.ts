// Telephony.Telnyx: what a host chose to make available.
//
 ...
 * happened to import.
 */
export class TelnyxServiceCollectionExtensions {
  ...
  add(name: string, service: unknown): TelnyxServiceCollectionExtensions {
