 ...
 */
export declare abstract class IChatGenerator {
    /**
     * Generates a complete assistant reply for the given conversation.
     */
    abstract generate(messages: readonly ChatMessage[], options?: GenerationOptions): Promise<string>;
    /**
     ...
     */
    abstract stream(messages: readonly ChatMessage[], options?: GenerationOptions): AsyncGenerator<string, void, unknown>;
