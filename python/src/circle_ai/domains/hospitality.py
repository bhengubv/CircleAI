...
class HospitalityDomainContext:
    ...
    topics: tuple[str, ...] = ('bookings', 'menus', 'shifts', 'reviews')
    ...
    refuses: str = 'post a review as a guest'
    because: str = 'a review has to be theirs'
...
class HospitalityCompanionAdapter:
    ...
    def __init__(
        self,
        context: "HospitalityDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or HospitalityDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> HospitalityDomainContext:
