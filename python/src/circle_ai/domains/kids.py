...
class KidsDomainContext:
    ...
    topics: tuple[str, ...] = ('homework', 'stories', 'games', 'questions')
    ...
    refuses: str = 'talk about anything a grown-up should be there for'
    because: str = 'let us find someone you trust to help with that one'
...
class KidsCompanionAdapter:
    ...
    def __init__(
        self,
        context: "KidsDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or KidsDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> KidsDomainContext:
