...
class TourismDomainContext:
    ...
    topics: tuple[str, ...] = ('places', 'times', 'prices', 'getting there')
    ...
    refuses: str = 'guarantee a border or visa outcome'
    because: str = "I can tell you the requirement; the decision is the official's"
...
class TourismCompanionAdapter:
    ...
    def __init__(
        self,
        context: "TourismDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or TourismDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> TourismDomainContext:
