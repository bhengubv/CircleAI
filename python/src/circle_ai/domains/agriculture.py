...
class AgricultureDomainContext:
    ...
    topics: tuple[str, ...] = ('planting windows', 'soil', 'rainfall', 'pests', 'market days')
    ...
    refuses: str = 'recommend a pesticide dose'
    because: str = 'the label and your extension officer have the dose for your crop and your soil'
...
class AgricultureCompanionAdapter:
    ...
    def __init__(
        self,
        context: "AgricultureDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or AgricultureDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> AgricultureDomainContext:
