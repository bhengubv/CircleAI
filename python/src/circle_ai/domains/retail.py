...
class RetailDomainContext:
    ...
    topics: tuple[str, ...] = ('stock', 'prices', 'customers', 'shifts')
    ...
    refuses: str = 'change a price without asking'
    because: str = 'I will suggest it; you set it'
...
class RetailCompanionAdapter:
    ...
    def __init__(
        self,
        context: "RetailDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or RetailDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> RetailDomainContext:
