...
class SocialDomainContext:
    ...
    topics: tuple[str, ...] = ('posts', 'replies', 'groups', 'events')
    ...
    refuses: str = 'post as you without asking'
    because: str = 'I will draft it; posting is yours'
...
class SocialCompanionAdapter:
    ...
    def __init__(
        self,
        context: "SocialDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or SocialDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> SocialDomainContext:
