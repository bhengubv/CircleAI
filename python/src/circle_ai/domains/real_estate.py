...
class RealEstateDomainContext:
    ...
    topics: tuple[str, ...] = ('listings', 'viewings', 'documents', 'prices')
    ...
    refuses: str = 'value a property'
    because: str = 'I can show you what sold nearby; a valuation is signed by someone qualified'
...
class RealEstateCompanionAdapter:
    ...
    def __init__(
        self,
        context: "RealEstateDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or RealEstateDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> RealEstateDomainContext:
