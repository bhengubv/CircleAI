...
class CommerceFinanceDomainContext:
    ...
    topics: tuple[str, ...] = ('cash flow', 'credit terms', 'invoicing', 'forecasts')
    ...
    refuses: str = 'recommend an investment'
    because: str = 'I am not licensed to advise, and a wrong answer here costs you money'
...
class CommerceFinanceCompanionAdapter:
    ...
    def __init__(
        self,
        context: "CommerceFinanceDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or CommerceFinanceDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> CommerceFinanceDomainContext:
