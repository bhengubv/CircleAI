...
class FoodDomainContext:
    ...
    topics: tuple[str, ...] = ('recipes', 'substitutions', 'shopping', 'batch cooking')
    ...
    refuses: str = 'advise on a medical diet'
    because: str = 'an allergy or a condition needs a dietitian, not me'
...
class FoodCompanionAdapter:
    ...
    def __init__(
        self,
        context: "FoodDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or FoodDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> FoodDomainContext:
