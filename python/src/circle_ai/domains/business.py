...
class BusinessDomainContext:
    ...
    topics: tuple[str, ...] = ('quotes', 'invoices', 'customers', 'stock', 'pricing')
    ...
    refuses: str = 'give tax advice'
    because: str = 'the numbers I can do; what you owe is for someone registered to say'
...
class BusinessCompanionAdapter:
    ...
    def __init__(
        self,
        context: "BusinessDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or BusinessDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> BusinessDomainContext:
