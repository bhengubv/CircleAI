...
class EducationDomainContext:
    ...
    topics: tuple[str, ...] = ('explanations', 'practice', 'marking', 'timetables')
    ...
    refuses: str = 'write an assessment you will submit as your own'
    because: str = 'I will teach it and check your attempt'
...
class EducationCompanionAdapter:
    ...
    def __init__(
        self,
        context: "EducationDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or EducationDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> EducationDomainContext:
