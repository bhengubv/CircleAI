...
class CommerceAccountingDomainContext:
    ...
    topics: tuple[str, ...] = ('ledgers', 'reconciliation', 'VAT', 'statements')
    ...
    refuses: str = 'sign off accounts'
    because: str = "reconciling I can do; signing is an accountant's"
...
class CommerceAccountingCompanionAdapter:
    ...
    def __init__(
        self,
        context: "CommerceAccountingDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or CommerceAccountingDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> CommerceAccountingDomainContext:
