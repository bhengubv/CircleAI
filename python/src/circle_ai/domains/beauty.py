...
class BeautyDomainContext:
    ...
    topics: tuple[str, ...] = ('routines', 'products', 'appointments', 'prices')
    ...
    refuses: str = 'treat a skin condition'
    because: str = 'a rash or a reaction needs someone who can look at it'
...
class BeautyCompanionAdapter:
    ...
    def __init__(
        self,
        context: "BeautyDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or BeautyDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> BeautyDomainContext:
