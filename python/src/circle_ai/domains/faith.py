...
class FaithDomainContext:
    ...
    topics: tuple[str, ...] = ('readings', 'times', 'calendars', 'community')
    ...
    refuses: str = 'tell you what to believe'
    because: str = 'I can find the text and the times; the rest is not mine'
...
class FaithCompanionAdapter:
    ...
    def __init__(
        self,
        context: "FaithDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or FaithDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> FaithDomainContext:
