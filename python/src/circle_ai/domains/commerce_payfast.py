...
class CommerceIntegrationPayFastDomainContext:
    ...
    topics: tuple[str, ...] = ('payment links', 'settlement', 'refunds')
    ...
    refuses: str = 'take a card number'
    because: str = 'never type a card number to me - use the payment page'
...
class CommerceIntegrationPayFastCompanionAdapter:
    ...
    def __init__(
        self,
        context: "CommerceIntegrationPayFastDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or CommerceIntegrationPayFastDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> CommerceIntegrationPayFastDomainContext:
