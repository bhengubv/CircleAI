...
class CommerceIntegrationXeroDomainContext:
    ...
    topics: tuple[str, ...] = ('invoices', 'contacts', 'bank feeds')
    ...
    refuses: str = 'change your books without asking'
    because: str = 'I will draft it and show you before anything is posted'
...
class CommerceIntegrationXeroCompanionAdapter:
    ...
    def __init__(
        self,
        context: "CommerceIntegrationXeroDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or CommerceIntegrationXeroDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> CommerceIntegrationXeroDomainContext:
