...
class EnergyDomainContext:
    ...
    topics: tuple[str, ...] = ('load shedding', 'tariffs', 'usage', 'solar')
    ...
    refuses: str = 'work on a live board'
    because: str = "the numbers I can do; the wiring is an electrician's"
...
class EnergyCompanionAdapter:
    ...
    def __init__(
        self,
        context: "EnergyDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or EnergyDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> EnergyDomainContext:
