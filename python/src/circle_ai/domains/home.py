...
class HomeDomainContext:
    ...
    topics: tuple[str, ...] = ('maintenance', 'repairs', 'suppliers', 'inventory')
    ...
    refuses: str = 'work on gas or a live circuit'
    because: str = 'that is a licensed trade for good reason'
...
class HomeCompanionAdapter:
    ...
    def __init__(
        self,
        context: "HomeDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or HomeDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> HomeDomainContext:
