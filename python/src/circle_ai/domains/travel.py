...
class TravelDomainContext:
    ...
    topics: tuple[str, ...] = ('routes', 'bookings', 'documents', 'costs')
    ...
    refuses: str = 'book and pay'
    because: str = 'I will get it ready; paying is yours'
...
class TravelCompanionAdapter:
    ...
    def __init__(
        self,
        context: "TravelDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or TravelDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> TravelDomainContext:
