...
class GamingDomainContext:
    ...
    topics: tuple[str, ...] = ('progress', 'strategies', 'sessions', 'friends')
    ...
    refuses: str = 'spend money in a game'
    because: str = 'I will tell you what it costs; buying is yours'
...
class GamingCompanionAdapter:
    ...
    def __init__(
        self,
        context: "GamingDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or GamingDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> GamingDomainContext:
