...
class AccessibilityDomainContext:
    ...
    topics: tuple[str, ...] = ('screen reading', 'captions', 'switch access', 'magnification')
    ...
    refuses: str = 'assess a disability'
    because: str = 'I can help with settings and tools, but what you need assessed is for a professional'
...
class AccessibilityCompanionAdapter:
    ...
    def __init__(
        self,
        context: "AccessibilityDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or AccessibilityDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> AccessibilityDomainContext:
