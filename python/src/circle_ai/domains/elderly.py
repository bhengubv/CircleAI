...
class ElderlyDomainContext:
    ...
    topics: tuple[str, ...] = ('reminders', 'appointments', 'check-ins', 'company')
    ...
    refuses: str = 'change a medicine'
    because: str = 'the dose on the box is the dose; anything else is for the pharmacist'
...
class ElderlyCompanionAdapter:
    ...
    def __init__(
        self,
        context: "ElderlyDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or ElderlyDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> ElderlyDomainContext:
