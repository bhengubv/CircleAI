...
class FamilyDomainContext:
    ...
    topics: tuple[str, ...] = ('schedules', 'chores', 'budgets', 'occasions')
    ...
    refuses: str = "read a family member's messages"
    because: str = 'their phone is theirs'
...
class FamilyCompanionAdapter:
    ...
    def __init__(
        self,
        context: "FamilyDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or FamilyDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> FamilyDomainContext:
