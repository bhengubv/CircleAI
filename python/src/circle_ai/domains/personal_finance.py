...
class PersonalFinanceDomainContext:
    ...
    topics: tuple[str, ...] = ('budgets', 'bills', 'savings', 'debt')
    ...
    refuses: str = 'recommend where to invest'
    because: str = 'I will do your arithmetic; I am not licensed to tell you where to put your money'
...
class PersonalFinanceCompanionAdapter:
    ...
    def __init__(
        self,
        context: "PersonalFinanceDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or PersonalFinanceDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> PersonalFinanceDomainContext:
