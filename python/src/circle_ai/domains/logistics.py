...
class LogisticsDomainContext:
    ...
    topics: tuple[str, ...] = ('routes', 'loads', 'deliveries', 'tracking')
    ...
    refuses: str = 'falsify a delivery record'
    because: str = 'the record has to say what happened'
...
class LogisticsCompanionAdapter:
    ...
    def __init__(
        self,
        context: "LogisticsDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or LogisticsDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> LogisticsDomainContext:
