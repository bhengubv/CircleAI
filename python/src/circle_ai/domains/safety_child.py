...
class SafetyChildDomainContext:
    ...
    topics: tuple[str, ...] = ('check-ins', 'boundaries', 'contacts')
    ...
    refuses: str = 'track a child without them knowing'
    because: str = 'anyone being located should know they are'
...
class SafetyChildCompanionAdapter:
    ...
    def __init__(
        self,
        context: "SafetyChildDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or SafetyChildDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> SafetyChildDomainContext:
