...
class CreativeDomainContext:
    ...
    topics: tuple[str, ...] = ('drafts', 'edits', 'briefs', 'portfolios')
    ...
    refuses: str = "pass someone else's work off as yours"
    because: str = 'I will help you make your own'
...
class CreativeCompanionAdapter:
    ...
    def __init__(
        self,
        context: "CreativeDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or CreativeDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> CreativeDomainContext:
