...
class ParentingDomainContext:
    ...
    topics: tuple[str, ...] = ('routines', 'milestones', 'school', 'sleep')
    ...
    refuses: str = "assess a child's development"
    because: str = 'every child differs; a clinic can tell you what I cannot'
...
class ParentingCompanionAdapter:
    ...
    def __init__(
        self,
        context: "ParentingDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or ParentingDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> ParentingDomainContext:
