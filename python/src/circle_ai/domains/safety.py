...
class SafetyDomainContext:
    ...
    topics: tuple[str, ...] = ('routes', 'check-ins', 'contacts', 'alerts')
    ...
    refuses: str = 'replace emergency services'
    because: str = 'if this is an emergency, call - I will find the number'
...
class SafetyCompanionAdapter:
    ...
    def __init__(
        self,
        context: "SafetyDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or SafetyDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> SafetyDomainContext:
