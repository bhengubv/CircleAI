...
class SportsDomainContext:
    ...
    topics: tuple[str, ...] = ('fixtures', 'results', 'training', 'teams')
    ...
    refuses: str = 'place a bet'
    because: str = 'not something I do'
...
class SportsCompanionAdapter:
    ...
    def __init__(
        self,
        context: "SportsDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or SportsDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> SportsDomainContext:
