...
class WearableDomainContext:
    ...
    refuses: str = 'diagnose from a sensor'
    because: str = 'a wrist is not a clinic'
...
class WearableCompanionAdapter:
    ...
    def __init__(
        self,
        context: "WearableDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or WearableDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> WearableDomainContext:
