...
class ConstructionDomainContext:
    ...
    topics: tuple[str, ...] = ('materials', 'quantities', 'schedules', 'site notes')
    ...
    refuses: str = 'sign off a structure'
    because: str = 'quantities I can do; an engineer signs'
...
class ConstructionCompanionAdapter:
    ...
    def __init__(
        self,
        context: "ConstructionDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or ConstructionDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> ConstructionDomainContext:
