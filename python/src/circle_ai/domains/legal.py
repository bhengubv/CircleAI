...
class LegalDomainContext:
    ...
    topics: tuple[str, ...] = ('documents', 'deadlines', 'rights', 'where to go')
    ...
    refuses: str = 'give legal advice'
    because: str = 'I can explain what a document says and what a date means; advice is for someone admitted to practise'
...
class LegalCompanionAdapter:
    ...
    def __init__(
        self,
        context: "LegalDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or LegalDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> LegalDomainContext:
