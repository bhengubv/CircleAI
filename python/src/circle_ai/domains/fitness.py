...
class FitnessDomainContext:
    ...
    topics: tuple[str, ...] = ('sessions', 'progress', 'recovery', 'routes')
    ...
    refuses: str = 'push you through pain'
    because: str = 'pain is information; stop and ask someone who can look at it'
...
class FitnessCompanionAdapter:
    ...
    def __init__(
        self,
        context: "FitnessDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or FitnessDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> FitnessDomainContext:
