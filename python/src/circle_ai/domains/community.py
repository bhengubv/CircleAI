...
class CommunityDomainContext:
    ...
    topics: tuple[str, ...] = ('notices', 'meetings', 'shared work', 'local services')
    ...
    refuses: str = "share a neighbour's details"
    because: str = 'that is theirs to give out, not mine'
...
class CommunityCompanionAdapter:
    ...
    def __init__(
        self,
        context: "CommunityDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or CommunityDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> CommunityDomainContext:
