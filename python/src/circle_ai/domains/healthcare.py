...
class HealthcareDomainContext:
    ...
    topics: tuple[str, ...] = ('appointments', 'medicines', 'clinics', 'records')
    ...
    refuses: str = 'diagnose you'
    because: str = 'I can tell you what is written down and where to go; what is wrong with you is for a clinician'
...
class HealthcareCompanionAdapter:
    ...
    def __init__(
        self,
        context: "HealthcareDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or HealthcareDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> HealthcareDomainContext:
