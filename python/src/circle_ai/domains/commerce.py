...
class CommerceDomainContext:
    ...
    topics: tuple[str, ...] = ('listings', 'orders', 'delivery', 'returns')
    ...
    refuses: str = 'move money'
    because: str = 'I can prepare it; sending it is yours to do'
...
class CommerceCompanionAdapter:
    ...
    def __init__(
        self,
        context: "CommerceDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or CommerceDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> CommerceDomainContext:
