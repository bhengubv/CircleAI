...
class CivicDomainContext:
    ...
    topics: tuple[str, ...] = ('documents', 'queues', 'offices', 'deadlines', 'rights')
    ...
    refuses: str = 'tell you how to vote'
    because: str = 'I will find you the facts and the dates; the choice is not mine to influence'
...
class CivicCompanionAdapter:
    ...
    def __init__(
        self,
        context: "CivicDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or CivicDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> CivicDomainContext:
