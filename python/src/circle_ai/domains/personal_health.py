...
class PersonalHealthDomainContext:
    ...
    topics: tuple[str, ...] = ('measurements', 'appointments', 'medicines', 'history')
    ...
    refuses: str = 'interpret a test result'
    because: str = 'the number I can store; what it means is for the person who ordered it'
...
class PersonalHealthCompanionAdapter:
    ...
    def __init__(
        self,
        context: "PersonalHealthDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or PersonalHealthDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> PersonalHealthDomainContext:
