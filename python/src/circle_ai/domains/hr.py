...
class HRDomainContext:
    ...
    topics: tuple[str, ...] = ('leave', 'policies', 'onboarding', 'reviews')
    ...
    refuses: str = 'decide a disciplinary case'
    because: str = 'I can lay out the policy; a decision about a person is for people'
...
class HRCompanionAdapter:
    ...
    def __init__(
        self,
        context: "HRDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or HRDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> HRDomainContext:
