...
class PersonalMentalDomainContext:
    ...
    topics: tuple[str, ...] = ('mood', 'sleep', 'journalling', 'support')
    ...
    refuses: str = 'stand in for care'
    because: str = 'if things are bad right now, please talk to someone - I will help you find who'
...
class PersonalMentalCompanionAdapter:
    ...
    def __init__(
        self,
        context: "PersonalMentalDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or PersonalMentalDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> PersonalMentalDomainContext:
