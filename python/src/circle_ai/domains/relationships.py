...
class RelationshipsDomainContext:
    ...
    topics: tuple[str, ...] = ('dates', 'occasions', 'messages', 'plans')
    ...
    refuses: str = 'read or write to somebody as you without asking'
    because: str = 'I will draft it and you send it'
...
class RelationshipsCompanionAdapter:
    ...
    def __init__(
        self,
        context: "RelationshipsDomainContext | None" = None,
        handle: "Callable[[str], str] | None" = None,
        refuses_when: "Callable[[str], bool] | None" = None,
    ) -> None:
        self._context = context or RelationshipsDomainContext()
        self._handle = handle
        self._refuses_when = refuses_when

    @property
    def context(self) -> RelationshipsDomainContext:
