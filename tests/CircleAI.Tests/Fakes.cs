...
/// </summary>
internal sealed class FakeBiometricStore : CircleAI.Identity.IBiometricStore
{
    private readonly Dictionary<string, CircleAI.Identity.BiometricProfile> _store = new();

    public int SaveCallCount   { get; private set; }
    public int GetCallCount    { get; private set; }
    public int DeleteCallCount { get; private set; }

    public Task<CircleAI.Identity.BiometricProfile?> GetAsync(
    ...
    public Task SaveAsync(
        CircleAI.Identity.BiometricProfile profile, CancellationToken ct = default)
    {
        SaveCallCount++;
