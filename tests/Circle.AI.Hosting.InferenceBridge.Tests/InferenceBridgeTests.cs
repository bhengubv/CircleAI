...
//
// End-to-end tests for the Circle.AI.Hosting.InferenceBridge contract and
// reference implementations (LocalProcessInferenceBridge, MockInferenceBridge).

using System.Diagnostics;
using System.Runtime.CompilerServices;
using System.Text.Json;
using Circle.AI.Hosting.InferenceBridge;
using Circle.AI.Inference;
using Xunit;

namespace Circle.AI.Hosting.InferenceBridge.Tests;
