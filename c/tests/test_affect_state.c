/*
 * test_affect_state.c — AffectState cross-language fixture tests.
 *
 * All expected values match fixtures/affect_state.json within epsilon=1e-5.
...
int main(void) {
     ...
     * positive: engagement=0.52, uncertainty=0.18, rapport=0.01
     * negative: engagement=0.52-0.03=0.49, uncertainty=0.18+0.03=0.21
     */
    s = ca_affect_state_default();
    ca_affect_state_positive_signal(&s);
    ca_affect_state_negative_signal(&s);
     ...
     * negative: engagement=0.47, uncertainty=0.23, rapport=0.0
     * positive: engagement=0.47+0.02=0.49, uncertainty=0.23-0.02=0.21, rapport=0+0.01=0.01
     */
    s = ca_affect_state_default();
    ca_affect_state_negative_signal(&s);
    ca_affect_state_positive_signal(&s);
     ...
     * engagement  = min(1.0, 0.99+0.02) = 1.0
     ...
     * engagement  = max(0.0, 0.01-0.03) = 0.0
     ...
     * engagement=0.5, energy=0.5 (already at neutral target)
