...
## نورون — یک مغز کوچک هوش مصنوعی روی دستگاه شما

**نورون** یک مغز کوچک هوش مصنوعی است که روی دستگاه خودِ شما اجرا می‌شود. فکر
می‌کند، به یاد می‌آورد و صحبت می‌کند — همان‌جا روی تلفن یا لپ‌تاپ شما، بدون آنکه
چیزی به سروری فرستاده شود. یک دستیار روزمرهٔ سریع به بیشتر پرسش‌ها پاسخ می‌دهد؛
و برای کاری دشوارتر (خواندن یک تصویر، یک سند طولانی، یا اندیشیدن دقیق
گام‌به‌گام) بی‌سروصدا یک متخصص را بارگذاری می‌کند، پاسخ می‌دهد و سپس آن را کنار
می‌گذارد. در هر لحظه فقط یک متخصص را نگه می‌دارد، بنابراین هرگز به حافظه‌ای بیش
از آنچه دستگاه دارد نیاز پیدا نمی‌کند، و گفت‌وگو را به یاد می‌سپارد تا هر چت از
همان‌جا که رها شده بود ادامه یابد.

**یک نورون، یا بسیاری — مغزی ساخته‌شده از مغزها.** یک نورون به‌تنهایی خوب کار
می‌کند. اما نورون‌ها می‌توانند به هم بپیوندند، مانند سلول‌های مغزی در یک مغز —
و قدرت واقعی همین‌جاست. (این بخش هنوز ساخته نشده است؛ این چیزی است که باور داریم
ممکن خواهد شد، و همان دلیلی است که این گره نورون نامیده می‌شود.) در یک گروه، کار
را میان خود تقسیم می‌کنند، هنگامی که یکی نمی‌تواند متخصصی را جای دهد به هم کمک
می‌کنند، همچون همتایانی برابر و بدون هیچ گرهِ فرمانده پاسخ می‌دهند، و داده‌های
خصوصی شما را روی دستگاه خودتان نگه می‌دارند — تنها چیزی که میان آن‌ها جابه‌جا
می‌شود پرسش است. هر نورون خود یک ذهن کامل است، پس گروهی از نورون‌ها ذهن‌های کامل
بسیاری هستند که به هم کمک می‌کنند تا کاری بیش از آنچه هر یک به‌تنهایی از عهده‌اش
برمی‌آمد انجام دهند.

نورون در پیاده‌سازی مرجع C# و همهٔ هفت پورت خواهر (Python, TypeScript, Go,
Kotlin, Swift, Rust, C) عرضه می‌شود. HarmonyOS/ArkTS هنوز در راه است.
