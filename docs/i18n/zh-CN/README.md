...
**神经元**是运行在你自己设备上的小型 AI 大脑。它就在你的手机或笔记本电脑上思考、记忆、交谈，不向服务器发送任何内容。一个快速的日常助手可以回答大多数问题；遇到更难的任务（读取图片、阅读长文档，或进行仔细的分步推理）时，它会悄悄加载一位专家，作答后再将其搁置。它每次只保留一位专家，因此所需内存永远不会超过设备本身的容量；它还会记住对话，让聊天从上次中断处继续。

**一个神经元，或许多个——由大脑组成的大脑。** 单个神经元本身就能很好地运作。但神经元也可以彼此连接，就像大脑中的脑细胞一样——真正的力量正源于此。（这一部分尚未实现；这是我们相信将会成为可能的事情，也是该节点被称为神经元的原因。）在群组中，它们分担工作，在某个神经元无法容纳某位专家时相互帮助，以平等的身份作答、没有任何节点充当主导，并将你的私人数据保留在你自己的设备上——在它们之间传递的始终只有问题本身。每个神经元本身已经是一个完整的心智，因此一组神经元就是许多完整的心智相互协作，共同完成任何单个神经元都无法独自完成的事情。

神经元已随 C# 参考实现以及全部七个姊妹移植版本（Python、TypeScript、Go、Kotlin、Swift、Rust、C）一同发布。HarmonyOS/ArkTS 尚待推出。
