//! md5.rs
//!
//! Pure-Rust MD5 (RFC 1321), hand-rolled to match the workspace convention of
//! self-contained hashes (see `memory::multimodal::sha256`) — no external crate.
//! Used by the PayFast signature builder, which mirrors the C#
...
/// Lowercase hex of a byte slice — matches C#
