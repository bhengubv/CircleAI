...
// ArkTS port: no `any`, explicit types, class-based patterns.
...
export interface FeedbackSignal {
  ...
  /** The EpisodicMemoryEntry id of the episode this feedback refers to, or null. */
...
export class PersonaState {
  ...
  /** Preferred response verbosity: "brief", "balanced" (default), or "detailed". */
  verbosity: string = 'balanced';

  /** Formality level: "casual", "neutral" (default), or "formal". */
  formality: string = 'neutral';

  /** Preferred response language/locale (IETF BCP-47). null = match device locale. */
...
/** Persists user feedback signals for later analysis. */
