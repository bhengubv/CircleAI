# Push the 3.6.0 bundle to GitHub Packages.
# Only CircleAI.Inference moved (3.3.0 -> 3.6.0, the mmap un-curse); the rest keep
# their versions and --skip-duplicate skips whatever the feed already holds.
