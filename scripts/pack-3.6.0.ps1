# Pack all v3.6.0 packages into nupkgs/.
# 3.6.0: mmap un-cursed (kvcache_mmap OFF is the fix) — a big model now loads on a
# small phone (Qwen2.5-3B on a 3.6 GB P30). See memory circleai-mmap-kvcache-crash-root-cause.
